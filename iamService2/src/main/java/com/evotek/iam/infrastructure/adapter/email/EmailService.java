package com.evotek.iam.infrastructure.adapter.email;

import com.evotek.iam.infrastructure.support.exception.ExternalErrorCode;
import com.evotek.iam.infrastructure.support.exception.ExternalException;
...
public class EmailService {
    ...
    public void sendMailForResetPassWord(String toEmail, String resetLink) {
        ...
        try {
            ...
            throw new ExternalException(ExternalErrorCode.FAIL_TO_SEND_MAIL);
        }
    }
